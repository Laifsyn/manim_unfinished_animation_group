...
class Scene:
    ...
    def begin_animations(self) -> None:
        ...
        import os, inspect
        print(
            f"  >Entering Scene::begin_animations(): Caller [{os.path.basename(inspect.currentframe().f_back.f_code.co_filename)}:{inspect.currentframe().f_back.f_lineno}] Callee [{os.path.basename(__file__)}:{inspect.currentframe().f_lineno}]"
        )
        ...
        print(
            f"  >Exitting Scene::begin_animations(): Caller [{os.path.basename(inspect.currentframe().f_back.f_code.co_filename)}:{inspect.currentframe().f_back.f_lineno}] Callee [{os.path.basename(__file__)}:{inspect.currentframe().f_lineno}]"
        )
